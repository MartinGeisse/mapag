...
public class StateMachineTest {
	...
	private static Alternative alternative1 = new Alternative(ImmutableList.of("r1", "r2", "r3"), "prec1");
	private static StateElement stateElement1 = new StateElement("aaa", alternative1, 0, "foo");

	private static Alternative alternative2 = new Alternative(ImmutableList.of("foo", "bar"), null);
	...
	public void testConstructorUnknownStartState() {
		Alternative alternativeX = new Alternative(ImmutableList.of("foo", "bar"), null);
