...
public class ProductionValidatorImplTest {
	...
	private static final Alternative ALTERNATIVE_1 = new Alternative(new SymbolReference("foo"));
	private static final Alternative ALTERNATIVE_2 = new Alternative(new SequenceExpression(new SymbolReference("abc"), new SymbolReference("bar")));
