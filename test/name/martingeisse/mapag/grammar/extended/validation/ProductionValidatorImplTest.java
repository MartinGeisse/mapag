...
public class ProductionValidatorImplTest {
	...
	private static final Alternative ALTERNATIVE_1 = new Alternative(null, new SymbolReference("foo"), null, null, false, false);
	private static final Alternative ALTERNATIVE_2 = new Alternative(null, new SequenceExpression(new SymbolReference("abc"), new SymbolReference("bar")), null, null, false, false);
