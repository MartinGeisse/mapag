...
public class NonterminalDefinitionTest {
	...
	private static final Alternative ALTERNATIVE_1 = new Alternative("a1", TestUtil.expansion("foo", "bar"), null);
	private static final Alternative ALTERNATIVE_2 = new Alternative("a2", TestUtil.expansion("a", "b"), null);
