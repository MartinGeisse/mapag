...
public class ProductionCanonicalizer {
	...
	private void work() {
		...
		for (Alternative inputAlternative : production.getAlternatives()) {
	...
	private name.martingeisse.mapag.grammar.canonical.Alternative convertAlternative(Alternative inputAlternative, int alternativeCounter) {
	...
	private AlternativeAttributes convertAttributes(Alternative inputAlternative) {
	...
	private String convertExpressionToSymbol(Expression expression) {
		...
		if (expression instanceof EmptyExpression) {
			...
			List<Alternative> repetitionAlternatives = new ArrayList<>();
			{
	...
	private Alternative syntheticAlternative(String name, Expression expression) {
