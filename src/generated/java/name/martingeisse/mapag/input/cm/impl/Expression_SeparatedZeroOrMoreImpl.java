...
public final class Expression_SeparatedZeroOrMoreImpl extends ExpressionImpl implements Expression_SeparatedZeroOrMore,PsiCm {

    public Expression_SeparatedZeroOrMoreImpl(@NotNull ASTNode node) {
        super(node);
    }
