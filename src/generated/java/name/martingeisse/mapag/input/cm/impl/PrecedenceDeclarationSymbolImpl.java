...
public final class PrecedenceDeclarationSymbolImpl extends ASTWrapperPsiElement implements PrecedenceDeclarationSymbol,PsiCm {

    public PrecedenceDeclarationSymbolImpl(@NotNull ASTNode node) {
        super(node);
    }
