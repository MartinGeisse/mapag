...
public final class Production_SingleNamedImpl extends ProductionImpl implements Production_SingleNamed,PsiCm {

    public Production_SingleNamedImpl(@NotNull ASTNode node) {
        super(node);
    }
    	...
    	public LeafPsiElement getAlternativeNamePsi() {
            ...
            return (RightHandSide)InternalPsiUtil.getCmFromPsi(InternalPsiUtil.getChild(this, 4));
        }

    	public RightHandSideImpl getRightHandSidePsi() {
            return (RightHandSideImpl)InternalPsiUtil.getChild(this, 4);
        }
