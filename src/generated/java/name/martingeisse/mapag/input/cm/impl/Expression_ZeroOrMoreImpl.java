...
public final class Expression_ZeroOrMoreImpl extends ExpressionImpl implements Expression_ZeroOrMore,PsiCm {

    public Expression_ZeroOrMoreImpl(@NotNull ASTNode node) {
        super(node);
    }
