...
public final class Production_SingleUnnamedImpl extends ProductionImpl implements Production_SingleUnnamed,PsiCm {

    public Production_SingleUnnamedImpl(@NotNull ASTNode node) {
        super(node);
    }
