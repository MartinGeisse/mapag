...
public final class Grammar_PrecedenceTableImpl extends ASTWrapperPsiElement implements Grammar_PrecedenceTable,PsiCm {

    public Grammar_PrecedenceTableImpl(@NotNull ASTNode node) {
        super(node);
    }

    	    public CmList<PrecedenceDeclaration> getPrecedenceDeclarations() {
