...
public final class Expression_OptionalImpl extends ExpressionImpl implements Expression_Optional,PsiCm {

    public Expression_OptionalImpl(@NotNull ASTNode node) {
        super(node);
    }
