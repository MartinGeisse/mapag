...
public final class Grammar_PrecedenceTable_1_PrecedenceDeclarations_Next extends Grammar_PrecedenceTable_1_PrecedenceDeclarations {

	public Grammar_PrecedenceTable_1_PrecedenceDeclarations_Next(@NotNull ASTNode node) {
		super(node);
	}

	public Grammar_PrecedenceTable_1_PrecedenceDeclarations getPrevious() {
		return (Grammar_PrecedenceTable_1_PrecedenceDeclarations) InternalPsiUtil.getChild(this, 0);
	}
