...
public class PsiFactory {
	...
	public static PsiElement createPsiElement(ASTNode node) {
		...
		if (type == Symbols.rightHandSideAttribute_ResolveBlock_ResolveDeclarations_Start) {
			return new RightHandSideAttribute_ResolveBlock_ResolveDeclarations_Start(node);
		}
		if (type == Symbols.rightHandSideAttribute_ResolveBlock_ResolveDeclarations_Next) {
			return new RightHandSideAttribute_ResolveBlock_ResolveDeclarations_Next(node);
		}
		...
		if (type == Symbols.rightHandSideAttribute_Precedence) {
			return new RightHandSideAttribute_Precedence(node);
		}
		if (type == Symbols.rightHandSideAttribute_ResolveBlock) {
			return new RightHandSideAttribute_ResolveBlock(node);
		}
		if (type == Symbols.rightHandSideAttribute_ReduceOnError) {
			return new RightHandSideAttribute_ReduceOnError(node);
		}
