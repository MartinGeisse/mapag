...
public abstract class Grammar_PrecedenceTable_PrecedenceDeclarations extends ASTWrapperPsiElement {

	public Grammar_PrecedenceTable_PrecedenceDeclarations(@NotNull ASTNode node) {
		super(node);
	}
